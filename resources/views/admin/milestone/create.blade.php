        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="create_milestone_form"  enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="milestone_name" id="milestone_name" class="form-control" placeholder="Enter Year" />
