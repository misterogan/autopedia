        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="create_feedback_form"  enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                            <div class="mb-15">
                                ...
                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Testimonial (English)</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="feedback_en" id="feedback_en" style="resize: none"></textarea>
                                        <small class="form-text text-dark font-weight-bold">Please enter Feedback in english</small>
                                    </div>
                                </div>

                                <div class="form-group row">
                                    <label class="col-lg-3 col-form-label">Testimonial (Indonesian)</label>
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="feedback_in" id="feedback_in" style="resize: none"></textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <small class="form-text text-dark font-weight-bold">Input image you want to upload, max 4 MB</small>
                                    </div>
                                    <br>
                                </div>
