        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="create_subcategory_form"  enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                            <div class="mb-15">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="subcategory_en_name" id="subcategory_en_name">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="subcategory_in_name" id="subcategory_in_name">
