                        ...
                        <div class="card-body">
                            <div class="mb-15">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name="subcategory_id" id="subcategory_id">
                                            ...
                                            @foreach($subcategories as $subcategory)
                                                <option value="{{$subcategory->id}}">{{$subcategory->subcategory_name_en}} / {{$subcategory->subcategory_name_in}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" class="form-control" name="filename_en" id="filename">
                                    </div>
                                </div>
