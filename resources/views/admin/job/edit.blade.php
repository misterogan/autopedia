        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card card-custom gutter-b example example-compact">
                    ...
                    <!--begin::Form-->
                    <form class="form" id="edit_job_form"  enctype="multipart/form-data" >
                        ...
                        <div class="card-body">
                            <div class="mb-15">
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="job_name" id="job_name" class="form-control" placeholder="Enter job name" value="{{$job->name}}" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <input type="text" name="location" id="location" class="form-control" placeholder="Enter job location" value="{{$job->location}}" />
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <select class="form-control" name="job_type" id="job_type">
                                            ...
                                            <option value="Fresh Graduate" @if($job->job_type=='Fresh Graduate') selected @endif>Fresh Graduate</option>
                                            <option value="Pro-Hire" @if($job->job_type=='Pro-Hire') selected @endif>Pro-Hire</option>
                                        </select>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="description_en" id="description_en" style="resize: none">{{$job->description_en}}</textarea>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-6">
                                        <textarea class="form-control" name="description_in" id="description_in" style="resize: none">{{$job->description_in}}</textarea>
                                        <small class="form-text text-dark font-weight-bold">Please enter description</small>
                                    </div>
                                </div>
