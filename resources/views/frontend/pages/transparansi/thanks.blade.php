        ...
        <div class="container-fluid">
            <div class="box-head">
                ...
                <p class="subtitle" data-aos="fade-up" data-aos-delay="400" data-aos-easing="ease-in-sine"
                    data-aos-duration="400">
                    {{__("Laporan anda telah kami terima dan akan kami tindak lanjuti dalam waktu 2x24 jam. Terima kasih telah berpartisipasi dalam mengawasi kegiatan usaha Autopedia.")}}
                </p>
