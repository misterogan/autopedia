    ...
    <meta name="image" content="{{ asset('assets/images/png/logo.png') }}">
    ...
    <meta itemprop="image" content="{{ asset('assets/images/png/logo.png') }}">
    ...
    <meta property="og:image" content="{{ asset('assets/images/png/logo.png') }}" />
    ...
    <meta name="twitter:image" content="{{ asset('assets/images/png/logo.png') }}" />
